module.exports = {
  ...
  addUserToChannel: async(req, res) => {
    ...
    console.log('line 41 from channels.js:', checkIfUserIsInChannel);
    if (checkIfUserIsInChannel[0]){
      let usersFromChannel = await db.get_users_from_channel(channel_id)
        .catch(err=>console.log(err))
      console.log('line 43 in channels.js:', usersFromChannel);
    ...
    console.log('line 48 from channels.js:', updatedUsersInChannel);
